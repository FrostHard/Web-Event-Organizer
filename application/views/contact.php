        ...
        <div class="row probootstrap-vh-75 align-items-center text-left">
            <div class="col-sm">
                <div class="probootstrap-text pt-5">
                    <h1 class="probootstrap-heading text-white mb-4">Contact us</h1>
                    <div class="probootstrap-subheading mb-5">
                        <p class="h4 font-weight-normal">if you have any inquiry or wishes to speak with us directly</u></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 pl-md-5 pl-3">
                ...
                <div class="media mb-5">
                    ...
                    <div class="media-body">
                        <h5 class="mt-0">Jl. Gatot Subroto No.Kav. 47, RT.6/RW.3, Kuningan, Kuningan Tim., Kecamatan Setiabudi, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12950</h5>
                    </div>
                </div>
                ...
                <div class="media mb-5">
                    ...
                    <div class="media-body">
                        <h5 class="mt-0">destiny.bloom7@gmail.com</h5>
                    </div>
                </div>
